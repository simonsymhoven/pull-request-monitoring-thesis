...
\title{Ein konfigurierbares und \\skalierbares Monitoringsystem}

\subtitle{für Delta-Metriken innerhalb des \\kontinuierlichen Integrationsservers Jenkins}

\author{Simon Symhoven \\ Boschetsriederstraße 59a \\ D-81379 München}
...
Informatik und Mathematik}} % Optional title page image, comment this line to remove it
...
\begin{frame}[t]
	This slide has an empty title and is aligned to top. It belongs to frame above.
\end{frame}

%------------------------------------------------

\begin{frame}{No Slide Numbering}
	This slide is citing reference \cite{knuth74}.
\end{frame}
